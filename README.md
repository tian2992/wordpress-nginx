...
The php pool configuration is located in `global/php-pool.conf`, it is default to PHP 7.1.  It will need modified if your php-fpm pool service is running in a different location or is a different PHP version.
